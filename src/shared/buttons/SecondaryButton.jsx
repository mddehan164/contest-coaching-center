    ...
    return (
        <button
            ...
            className={cx(
                ...
                isOutlined ? "border border-main-500 text-main-500 bg-transparent hover:border-main-500/80 hover:text-main-500/80 disabled:text-text-disabled disabled:border-text-disabled" : "bg-main-500 text-white border-none hover:bg-main-500/80 disabled:bg-text-disabled",
