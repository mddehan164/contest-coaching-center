  ...
  return (
    <div className='w-full h-36 sm:h-44 md:h-52 lg:h-60 2xl:h-64 flex items-center justify-between'>
      <div className=' w-[60%] lg:w-[50%] h-full no-scrollbar overflow-y-auto'>
        ...
        <h1 className={`text-base md:text-xl lg:text-2xl xl:text-3xl font-semibold ${data.color} lg:mt-8`}>{data.data.title}</h1>
      ...
      <div className='w-[40%] flex justify-end items-end'>
        ...
        <img src={data.img} alt="hero" className='w-full h-auto sm:w-[80%] lg:w-[85%] xl:w-[70%] 2xl:w-[60%]'/>
      </ScrollAnimatedSection>
      </div>
    </div>
  )
