...
const SuccessCards = () => {
  return (
    <div className='w-full relative'>
      <h1 className='w-full text-xl font-bold text-center my-6 text-headerColorHover sm:text-3xl md:text-2xl md:mt-12 lg:mt-16'>{successData.mainTitle}</h1>
      <div className='flex flex-wrap justify-center items-center gap-5 p-3'>
        {
          successData.mainData.map((stat, index) => (<div key={index} className='w-full sm:w-1/2 md:w-1/3 lg:w-1/4'><Stats stat={stat}/></div>))
        }
      </div>
