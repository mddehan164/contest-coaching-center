...
const PaymentDetails = ({ details, onClose, onOpenAdd }) => {
          ...
          <table className="w-full border-collapse text-sm md:text-base rounded-lg overflow-hidden">
            <thead className="bg-[#102542] text-white lg:text-lg">
              <tr>
                ...
                <th className="px-4 py-2 border">Course Fee</th>
            ...
            <tbody>
              {details.map((item) => (
                <tr key={item.id} className="hover:bg-contestLight text-center">
                  ...
                  <td className="px-4 py-2 border">
                    ৳ {item?.course_fee || "Not Found"}
                  </td>
                  <td className="px-4 py-2 border">
                    ৳ {item?.payable_amount || "Not Found"}
                  </td>
                  <td className="px-4 py-2 border">
