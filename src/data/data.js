...
export const statsData = [
  {
    title: "BUET",
    count: "1290+",
    des: "২০২৩ BUET ভর্তি পরীক্ষায় লেখ পরীক্ষায় প্রথম ৫০ ও ১০০ জন সহ ৯০টিরও অধিক অ্যাডমিশন টেস্টে অংশ নিয়ে ঢাকা পেয়েছে ।",
    Icon: FaUniversity,
  ...
  },
  {
    title: "মেডিকেল",
    count: "4300+",
    des: "২০২৩ মেডিকেল ভর্তি পরীক্ষায় জাতীয় মেধায় প্রথম ৫০ ও ১০০ জন এবং DMC-তে ৪৯ জনসহ ৬৩০টি অ্যাডমিশনে ঢাকায় পেয়েছে ।",
    Icon: FaStethoscope,
  ...
  },
  {
    title: "চাবি'ক",
    count: "1800+",
    des: "২০২৩ চাবি'ক ইউনিট ভর্তি পরীক্ষায় লেখ পরীক্ষায় প্রথম ৫০ ও ১০০ জন সহ ১৮০টিরও অধিক অ্যাডমিশনে ঢাকায় পেয়েছে ।",
  ...
  },
  {
    title: "CKRUET",
    count: "3180+",
    des: "২০২৩ CKRUET ভর্তি পরীক্ষায় লেখ পরীক্ষায় প্রথম ৫০ ও ১০০ জন সহ ৬৩০টিরও অধিক অ্যাডমিশনে ঢাকায় পেয়েছে ।",
    Icon: FaTools,
  ...
  },
  {
    title: "RUET",
    count: "2900+",
    des: "২০২৩ RUET ভর্তি পরীক্ষায় বিশাল সংখ্যক শিক্ষার্থী ভর্তি হয়েছে এবং তাদের পারফর্মেন্স ছিল অসাধারণ।",
    Icon: FaTools,
  ...
  },
  {
    title: "CUET",
    count: "3100+",
    des: "২০২৩ CUET ভর্তি পরীক্ষায় শীর্ষ র্যাংকধারী শিক্ষার্থীদের মধ্যেও অনেকেই এখানে ভর্তি হয়েছেন।",
    Icon: FaTools,
