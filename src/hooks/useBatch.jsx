...
import { useGetBatchByIdQuery } from "../redux-rtk/batch/batchApi";
import {
  CreateBatchSchema,
  EditBatchSchema,
  validateZodSchema,
...
export const useBatchs = () => {
  ...
  //   const [viewBatch, { isLoading: viewLoading }] = useGetBatchByIdQuery();
  ...
  const {
    ...
    error: viewError,
  } = useGetBatchByIdQuery(selectedData?.encrypted_id ?? skipToken);
  ...
  }, [viewData, dispatch, selectedData]);
  ...
  const handleOpenConfirmationModal = () =>
    dispatch(setBatchConfirmationModal(true));
  ...
  const handleView = () => {
    dispatch(setBatchConfirmationModal(true)); // শুধু UI ট্রিগার
  };
