...
export const useTeachers = () => {
  ...
  const handleSetSelectedTeacher = (data) =>
    dispatch(setSelectedTeacherData(data));
  ...
  const handleOpenConfirmationModal = () =>
    dispatch(setTeacherConfirmationModal(true));
...
export const useAddTeacher = () => {
  ...
  const handleImageUpload = async (file) => {
    ...
    try {
      ...
      const demoImageUrl = `https://example.com/teachers/${file.name
        .replace(/\s+/g, "-")
        .toLowerCase()}`;
