...
export const useBranches = () => {
    ...
    const handleSetSelectedBranch = (data) => dispatch(setSelectedBranchData(data));
    ...
    const handleOpenConfirmationModal = () => dispatch(setBranchConfirmationModal(true));
...
export const useEditBranch = ({ data }) => {
    ...
    const { isEditModalOpen, selectedData } = useSelector((state) => state.branch);
    const [isUploading, setIsUploading] = useState(false);
    const [imagePreview, setImagePreview] = useState("");
    ...
    useEffect(() => {
        if (selectedData && isEditModalOpen) {
            ...
            setValue("status", selectedData.status || "active");
    ...
    }, [selectedData, setValue, isEditModalOpen]);
    ...
    const handleEditBranch = (data) => {
        ...
        updateBranch({ 
            data: formData, 
            branchId: selectedData.encrypted_id 
        })
            .unwrap()
            .then((response) => {
