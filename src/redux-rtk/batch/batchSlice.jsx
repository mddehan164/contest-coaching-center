...
const batchSlice = createSlice({
  ...
  reducers: {
    ...
    setBatchData: (state, action) => {
      const { batches, pagination } = action.payload.data;
    ...
    addNewBatchToList: (state, action) => {
      const newBatch = {
        ...action.payload,
      };
    ...
    setBatchConfirmationModal: (state, action) => {
      state.isConfirmModalOpen = action.payload;
    },

    setAddBatchModal: (state, action) => {
      state.isAddModalOpen = action.payload;
    },

    setEditBatchModal: (state, action) => {
