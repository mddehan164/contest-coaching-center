...
const uiSlice = createSlice({
  ...
  reducers: {
    ...
    setScrollAnimatedSections: (state, action) => {
      state.scrollAnimatedSections = { ...state.scrollAnimatedSections, ...action.payload }
    },
...
export const selectScrollAnimatedSections = (state) => state.ui.scrollAnimatedSections
